...
class BattleManager {
     ...
     *
     * @param AbstractShip $ship1, int $ship1Quantity, AbstractShip $ship2, int $ship2Quantity, string $battleType
     * 
     * @return BattleResult
     */
    public function battle(AbstractShip $ship1, $ship1Quantity, AbstractShip $ship2, $ship2Quantity, $battleType) {
        ...
        while ($ship1Health > 0 && $ship2Health > 0) {
            ...
            if (strpos($battleType, self::TYPE_NO_JEDI) === false && $this->didJediDestroyShipUsingTheForce($ship1)) {
                $ship2Health = 0;
            ...
            if (strpos($battleType, self::TYPE_NO_JEDI) === false && $this->didJediDestroyShipUsingTheForce($ship2)) {
                $ship1Health = 0;
            ...
            if (strpos($battleType, self::TYPE_ONLY_JEDI) === false) {           
                // now battle them normaly
